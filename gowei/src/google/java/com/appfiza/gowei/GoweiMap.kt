...
class GoweiMap(
    ...
    override fun isMarkerAvailable(markerID: String): Boolean = markers.containsKey(markerID)
    ...
    override fun setMyLocationButtonEnabled(enabled: Boolean) {
        mMap.uiSettings.isMyLocationButtonEnabled = enabled
    }
